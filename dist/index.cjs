...
__export(index_exports, {
  ...
  applyJsonLogic: () => applyJsonLogic,
  buildSubmissionPayload: () => buildSubmissionPayload,
  createDefaultAdapter: () => createDefaultAdapter,
  createFormEngine: () => createFormEngine,
  defaultApiAdapter: () => defaultApiAdapter,
  evaluateDependencies: () => evaluateDependencies,
  isTruthy: () => isTruthy,
  normalizeSubmissionData: () => normalizeSubmissionData,
...
function useFFForm(props) {
  ...
  const readyFired = (0, import_react.useRef)(false);
  const adapter = resolveAdapter(apiAdapter);
  const getKey = (0, import_react.useCallback)(() => resolveEffectiveApiKey(apiKey, getApiKey), [apiKey, getApiKey]);
  ...
  const changeField = (0, import_react.useCallback)((fieldId, value) => {
    engineRef.current?.changeField(fieldId, value);
  }, []);
  const isVisible = (0, import_react.useCallback)((id) => !state.fieldStates[id]?.hidden, [state.fieldStates]);
  const isDisabled = (0, import_react.useCallback)((id) => state.fieldStates[id]?.disabled ?? false, [state.fieldStates]);
  const isReadonly = (0, import_react.useCallback)((id) => mode === "readonly" || (state.fieldStates[id]?.readonly ?? false), [mode, state.fieldStates]);
  const isRequired = (0, import_react.useCallback)((id) => state.fieldStates[id]?.required ?? false, [state.fieldStates]);
  const doSubmit = (0, import_react.useCallback)(async (isFinal) => {
    const engine = engineRef.current;
    if (!engine) return;
  ...
  const submitDraft = (0, import_react.useCallback)(() => doSubmit(false), [doSubmit]);
  const submitFinal = (0, import_react.useCallback)(() => doSubmit(true), [doSubmit]);
  const reset = (0, import_react.useCallback)(() => {
    engineRef.current?.reset();
    dispatch({ type: "CLEAR_ERRORS" });
  }, []);
  const reload = (0, import_react.useCallback)(() => load(), [load]);
  const uploadMediaForField = (0, import_react.useCallback)(async (fieldId, file) => {
    if (onUploadMedia) {
  ...
  const deleteMediaItem = (0, import_react.useCallback)(async (mediaUuid) => {
    const key = await getKey();
    return adapter.deleteMedia({ apiBaseUrl, apiKey: key, submissionId, mediaUuid });
  }, [adapter, apiBaseUrl, getKey, submissionId]);
  const fetchLookupList = (0, import_react.useCallback)(async (listId) => {
    const key = await getKey();
...
function PageListView({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "ff-form__page-list", children: pages.map((page, idx) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ff-form__page-card-number", children: idx + 1 }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ff-form__page-card-info", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ff-form__page-card-title", children: page.title ?? `Page ${idx + 1}` }),
            page.description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ff-form__page-card-desc", children: page.description }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ff-form__page-card-meta", children: [
              total,
              " field",
              total !== 1 ? "s" : "",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ff-form__page-card-right", children: [
            errors > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ff-form__page-card-badge ff-form__page-card-badge--error", children: [
              errors,
              " error",
              errors !== 1 ? "s" : ""
            ] }) : missing > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "ff-form__page-card-badge ff-form__page-card-badge--warn", children: [
              missing,
              " required"
            ] }) : null,
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ff-form__page-card-arrow", "aria-hidden": "true", children: "\u203A" })
          ] })
        ]
      },
      page.id
...
function NumberField({
  ...
  if (isCounter) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "ff-form__counter", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "ff-form__counter-value", children: isNaN(num) ? min ?? 0 : num }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "button",
        {
          type: "button",
...
function SelectField({
  ...
  const [options, setOptions] = (0, import_react2.useState)(staticOptions);
  const [lookupLoading, setLookupLoading] = (0, import_react2.useState)(false);
  const fetchedIdRef = (0, import_react2.useRef)(null);
  ...
  if (lookupLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "ff-form__select-loading", children: "Loading options\u2026" });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    "select",
    {
      ...
      children: [
        !isMultiple && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "", children: field.placeholder ?? "\u2014 Select \u2014" }),
        options.map((opt) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "option",
          {
...
function CheckboxField({
  ...
  if (isSwitch) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { className: "ff-form__switch-label", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ff-form__switch-track", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ff-form__switch-thumb" }) }),
  ...
  if (options.length > 0) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "ff-form__checkbox-group", role: "group", children: options.map((opt) => {
      const checked = selected.some((v) => String(v) === String(opt.value));
      const id = `${field.id}-${opt.value}`;
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { className: "ff-form__checkbox-label", htmlFor: id, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          "input",
          {
            id,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ff-form__checkbox-text", children: opt.label })
      ] }, String(opt.value));
    }) });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("label", { className: "ff-form__checkbox-label", htmlFor: field.id, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      "input",
      {
        id: field.id,
    ...
    settings.label !== false && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "ff-form__checkbox-text", children: field.label ?? field.title ?? "" })
  ] });
}
...
function MediaField({
  ...
  const objectUrlsRef = (0, import_react3.useRef)([]);
  const requestedFetchesRef = (0, import_react3.useRef)(/* @__PURE__ */ new Set());
  const [uploadErrors, setUploadErrors] = (0, import_react3.useState)([]);
  const [fetchErrors, setFetchErrors] = (0, import_react3.useState)({});
  const [fetchingMedia, setFetchingMedia] = (0, import_react3.useState)({});
  const [resolvedMedia, setResolvedMedia] = (0, import_react3.useState)({});
  const [viewerEntry, setViewerEntry] = (0, import_react3.useState)(null);
  const settings = field.settings ?? {};
  ...
  function renderMediaPreview(entry) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__media-file-icon", "aria-hidden": "true", children: label });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "ff-form__media-field", children: [
    canAdd && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    ...
    entries.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("ul", { className: "ff-form__media-list", children: entries.map((entry) => {
      const media = getDisplayMedia(entry);
      return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("li", { className: "ff-form__media-item", children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { className: "ff-form__media-meta", children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__media-name", children: media.name }),
                fetchingMedia[entry.uuid] && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__media-status", children: "Loading media..." }),
                fetchErrors[entry.uuid] && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__media-status ff-form__media-status--error", children: fetchErrors[entry.uuid] })
              ] })
            ]
          }
        ),
        !readonly && !disabled && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "button",
          {
            type: "button",
    ...
    viewerEntry && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "ff-form__media-viewer-panel", children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "ff-form__media-viewer-header", children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__media-viewer-title", children: getDisplayMedia(viewerEntry).name }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "ff-form__media-viewer-body", children: (() => {
            const media = getDisplayMedia(viewerEntry);
            if (fetchingMedia[viewerEntry.uuid] && !media.url) {
              return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__media-viewer-empty", children: "Loading media..." });
            }
            if (media.isImage && media.url) {
              return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("img", { src: media.url, alt: media.name, className: "ff-form__media-viewer-image" });
            }
            if (media.isPdf && media.url) {
              return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("iframe", { src: media.url, title: media.name, className: "ff-form__media-viewer-frame" });
            }
            if (media.isVideo && media.url) {
              return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("video", { src: media.url, className: "ff-form__media-viewer-video", controls: true });
            }
            if (media.isAudio && media.url) {
              return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("audio", { src: media.url, className: "ff-form__media-viewer-audio", controls: true });
            }
            return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "ff-form__media-viewer-empty", children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: fetchErrors[viewerEntry.uuid] ?? "Preview is not available for this file." }),
              media.url && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
                "a",
                {
    ...
    entries.length === 0 && (readonly || disabled) && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__media-empty", children: "No files" }),
    uploadErrors.map((msg, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { className: "ff-form__error", role: "alert", children: msg }, i))
  ] });
}
...
function SubFormField({
  ...
  if (subformSchema) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "ff-form__subform", children: [
      ...
      allowMany && !readonly && !disabled && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "button",
        {
          type: "button",
...
function ChoiceField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "ff-form__choice-group", role: "group", "aria-label": field.label ?? field.title, children: options.map((opt) => {
...
function LocationField({
  ...
  const [fetching, setFetching] = (0, import_react5.useState)(false);
  const [geoError, setGeoError] = (0, import_react5.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "ff-form__location", children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "ff-form__location-row", children: [
      ...
      !readonly && !disabled && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
        "button",
        {
          type: "button",
    ...
    geoError && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: "ff-form__error", children: geoError }),
    hasCoords && mapsUrl && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      "a",
      {
        href: mapsUrl,
        target: "_blank",
...
function SignatureField({
  ...
  const objectUrlRef = (0, import_react6.useRef)(null);
  const [isDrawing, setIsDrawing] = (0, import_react6.useState)(false);
  ...
  if (signatureUrl && !isDrawing) {
    return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "ff-form__signature-preview", children: [
      isFetching ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "ff-form__signature-loading", children: "Loading signature..." }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("img", { src: signatureUrl, alt: "Signature" }),
      !disabled && !readonly && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "ff-form__signature-actions", style: { marginTop: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", className: "ff-form__btn ff-form__btn--draft", onClick: clear, children: "Clear & Re-sign" }) })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "ff-form__signature-container", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "ff-form__signature-actions", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", className: "ff-form__btn ff-form__btn--draft", onClick: clear, disabled: disabled || readonly, children: "Clear" }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("button", { type: "button", className: "ff-form__btn ff-form__btn--submit", onClick: save, disabled: disabled || readonly || isEmpty2, children: "Save Signature" })
    ] })
  ] });
}
...
function FallbackField({ field }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "ff-form__field-unsupported", children: [
    "Unsupported field type: ",
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("code", { children: field.type })
  ] });
}
function FieldRenderer(props) {
  ...
  if (!Component) return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(FallbackField, { field });
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Component, { ...props });
}
...
function SectionRenderer({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "ff-form__section-fields", children: visibleFields.map((field) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
      "div",
      {
        ...
        children: [
          !isLabelless && (field.label || field.title) && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("label", { className: "ff-form__label", htmlFor: field.id, children: [
            field.label ?? field.title,
            isRequired && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "ff-form__required", "aria-hidden": "true", children: " *" })
          ] }),
          field.description && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: "ff-form__field-description", children: field.description }),
          ...
          errors?.map((msg, i) => /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "ff-form__error", role: "alert", children: msg }, i))
        ]
      },
      field.id
    );
...
function SectionAccordion({
  ...
  const [, setExpanded] = (0, import_react7.useState)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "ff-form__sections", children: sections.filter((s) => !fieldStates[s.id]?.hidden).map((section) => {
    const isOpen = true;
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ff-form__section-header-title", children: section.title ?? "Section" }),
                /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "ff-form__section-header-right", children: hasBadge && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                  "span",
                  {
          ...
          isOpen && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "ff-form__section-body", children: [
            section.description && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "ff-form__section-description", children: section.description }),
...
function PageDetailView({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "ff-form__page-detail", children: [
    /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "ff-form__page-detail-topbar", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("span", { className: "ff-form__page-detail-pager", children: [
        pageIndex + 1,
        " / ",
        totalPages
      ] })
    ] }),
    page.title && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("h2", { className: "ff-form__page-title", children: page.title }),
    page.description && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: "ff-form__page-description", children: page.description }),
    /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
      SectionAccordion,
      {
    ...
    totalPages > 1 && /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "ff-form__page-nav", children: [
      /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(
        "button",
        {
          type: "button",
...
function FFForm(props) {
  ...
  const [currentPageId, setCurrentPageId] = (0, import_react8.useState)(null);
  const commonProps = (0, import_react8.useMemo)(() => ({
    data,
    fieldStates,
    validationErrors,
    mode,
  ...
  if (loading) {
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: `ff-form ff-form--loading ${className ?? ""}`, style, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "ff-form__loading", "aria-live": "polite", "aria-busy": "true", children: "Loading\u2026" }) });
  }
  if (error) {
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: `ff-form ff-form--error ${className ?? ""}`, style, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "ff-form__load-error", role: "alert", children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("strong", { children: "Failed to load form:" }),
      " ",
      error.message
    ] }) });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(
    "div",
    {
      ...
      style,
      children: [
        schema.title && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "ff-form__header", children: [
          /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("h1", { className: "ff-form__title", children: schema.title }),
          schema.description && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("p", { className: "ff-form__description", children: schema.description })
        ] }),
        hasGlobalErrors && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("div", { className: "ff-form__validation-banner", role: "alert", children: "Please correct the highlighted errors before submitting." }),
        !isMultiPage && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          SectionAccordion,
          {
        ...
        isMultiPage && !currentPage && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
          PageListView,
          {
            pages,
            fieldStates,
        ...
        !isReadonlyMode && (!isMultiPage || !currentPage) && /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "ff-form__actions", children: [
